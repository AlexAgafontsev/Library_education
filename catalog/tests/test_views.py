...
from Library_education.locallibrary.catalog.models import Author
...
from Library_education.locallibrary.catalog.models import BookInstance, Book, Genre, Language
